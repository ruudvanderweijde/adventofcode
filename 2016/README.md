...
<details>
<summary>Day 18: Like a Rogue</summary>
--- Day 18: Like a Rogue ---
...
```
part1: count=2013 in (0.001630 seconds)
part2: count=20006289 in (16.562784 seconds)
```

<details>
<summary>Day 19: An Elephant Named Joseph</summary>
...
```
part1: elf=1830117 in (0.000005 seconds)*
part2: elf=1417887 in (0.396066 seconds)*
```

*Solutions are taken from [The Josephus Problem - Numberphile](https://www.youtube.com/watch?v=uCsD3ZGzMgE) and [reddit](https://www.reddit.com/r/adventofcode/comments/5j4lp1/2016_day_19_solutions/).

<details>
<summary>Day 20: Firewall Rules</summary>
...
```
part1: min=22887907 in (0.001790 seconds)
part2: count=109 in (0.027543 seconds)
```

<details>
<summary>Day 21: Scrambled Letters and Hash</summary>
...
```
part1: password=gfdhebac in (0.000405 seconds)
part2: password=dhaegfbc in (15.380377 seconds)
```